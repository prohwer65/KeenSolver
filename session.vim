...
badd +1 KeenBoard.pm
badd +1 t\KeenBoard.t
badd +15 KeenCell.pm
badd +14 t\KeenCell.t
argglobal
%argdel
$argadd KeenBoard.pm
...
vnoremap <buffer> <silent> \iz :call mmtemplates#core#InsertTemplate(g:Perl_Templates,"Idioms.self")
nnoremap <buffer> <silent> \iz :call mmtemplates#core#InsertTemplate(g:Perl_Templates,"Idioms.self")
...
inoremap <buffer> <silent> \iz u:call mmtemplates#core#InsertTemplate(g:Perl_Templates,"Idioms.self","i")
...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 118 + 116) / 233)
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 61 - ((60 * winheight(0) + 29) / 58)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 61
...
setlocal cursorlineopt=both
setlocal define=[^A-Za-z_]
setlocal dictionary=~/vimfiles/perl-support/wordlists/perl.list,~/vimfiles/perl-support/wordlists/perl.list
setlocal nodiff
setlocal equalprg=
setlocal errorformat=
setlocal expandtab
